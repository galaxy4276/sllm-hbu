...
export default function Question3Screen() {
  ...
  const question = {
    id: 3,
    title: '외향성',
    text: '사람들과 함께 있을 때와 혼자 있을 때 중 어떤 게 더 편하신가요?',
    hint: '예: 함께 있을 때 에너지를 얻어요, 혼자만의 시간이 소중해요 등'
  };
  ...
  const handleSubmit = async () => {
    ...
    console.log('Question 3 Answer:', userInput);
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <View style={styles.content}>
              ...
              <View style={styles.progressContainer}>
                ...
                <ThemedText style={styles.progressText}>3/5</ThemedText>
              </View>
