...
export default function Question5Screen() {
  ...
  const question = {
    ...
    hint: '예: 운동을 해요, 음악을 들어요, 친구와 대화해요 등'
  };
  ...
  const handleSubmit = async () => {
    ...
    console.log('Question 5 Answer:', userInput);
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <View style={styles.content}>
              ...
              <View style={styles.progressContainer}>
                ...
                <ThemedText style={styles.progressText}>5/5</ThemedText>
              </View>
              ...
              <ThemedText style={styles.completeNote}>
                마지막 질문이에요!
              </ThemedText>
            </View>
        </ScrollView>
